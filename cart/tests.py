...
class ProductTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # creating test brand
        self.brand = Brand(name='Philips', website='http://www.philips.com/prod123/')
        self.brand.save()
...
class BrandTestCase(TestCase):
    ...
    def test_create_unique_brand(self):
        ...
        """
        brand1 = Brand(name='Philips', website='http://www.philips.com/prod123/')
        brand1.save()

        # brand name should be unique
        brand2 = Brand(name='Philips', website='http://www.philips.com/prod123/')
...
class ReviewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.product = Product(name='Philips Xyz', brand=self.brand, description="some description",
                price=200.35, currency=self.currency, url="www.philipsabc.com")
        self.product.save()
